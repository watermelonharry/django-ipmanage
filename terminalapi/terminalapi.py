...
class Dispatcher(object):
    ...
    def dispatch_dict(self, module, callback):
        try:
            self.__dispatch_dict.update({module: callback})
        except Exception as e:
            return False
    ...
    def register_module(self, module, callback):
        ...
        :return:
        """
        return self.dispatch_dict(module, callback)
    ...
    def dispatch(self, module, *args, **kwargs):
        ...
        if self.dispatch_dict.has_key(module):
            return self.dispatch_dict.get(module)(*args, **kwargs)
        else:
            pass
